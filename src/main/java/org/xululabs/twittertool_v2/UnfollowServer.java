...
public class UnfollowServer extends AbstractVerticle {
	 HttpServer server;
	 Router router;
	 ...
	 */
		...
		try {
			...
			FreindshipResponse = this.destroyFriendShip(this.getTwitterInstance(credentials.get("consumerKey"),credentials.get("consumerSecret"),
							credentials.get("accessToken"),credentials.get("accessTokenSecret")), followIds);
